...
RESPONSES = {
    FlagStatus.QUEUED: ['[OFFLINE] CTF not running',],
    FlagStatus.ACCEPTED: ["[OK]"],
    FlagStatus.REJECTED: ['[ERR] This is your own flag',"[ERR] Can't submit flag from NOP team","[ERR] Already submitted","[ERR] Expired","[ERR] Invalid flag","[ERR] Invalid format"],
}
